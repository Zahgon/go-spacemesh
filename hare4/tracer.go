...
func (noopTracer) OnCompactIdRequest(*CompactIdRequest) { _ = "STUB: not implemented"; return }

func (noopTracer) OnCompactIdResponse(*CompactIdResponse) { _ = "STUB: not implemented"; return }
